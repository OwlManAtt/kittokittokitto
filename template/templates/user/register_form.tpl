...
<form action='{$display_settings.public_dir}/{$self.slug}' method='post'>
	...
	<table class='dataTable'>
		...
		<tr>
			<td class='dataTableSubhead'><label for='user[user_name]'>User Name</label></td>
		...
		<tr>
			<td class='dataTableSubhead'><label for='user[password_again]'>Password Again</label></td>
			<td class='dataTableRow'>
        ...
        <tr>
			<td class='dataTableSubhead'><label for='user[email]'>E-mail Address</label></td>
			<td class='dataTableRow'>
		...
		<tr>
			<td class='dataTableSubhead'><label for='user[age]'>Age</label></td>
			<td class='dataTableRow'>
		...
		<tr>
			<td class='dataTableSubhead'><label for='user[gender]'>Gender</label></td>
			<td class='dataTableRow'>
		...
		<tr>
			<td class='dataTableSubhead' align='center'>
		...
		<tr>
			<td colspan='2' class='dataTableRow' align='center'>
