...
INSERT INTO `cron_tab` (`cron_tab_id`, `cron_class`, `cron_frequency_seconds`, `unixtime_next_run`, `enabled`) VALUES (1,'Job_RestockShops',3600,1190810911,'Y'),(2,'Job_UserOnline',300,1190808456,'Y');
UNLOCK TABLES;
