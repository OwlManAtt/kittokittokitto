...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=latin1 COMMENT='Links a color to a specie. Without entry, specie cannot beco';
SET character_set_client = @saved_cs_client;
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COMMENT='Pets = specie + user + color.';
SET character_set_client = @saved_cs_client;
